...
| keytool -keystore ca.jks -storepass password -gencert -validity 10000 -alias ca -ext ku:c=dig,keyEnc -ext "san=dns:localhost,ip:192.1.1.18" -ext eku=sa,ca -rfc > server.pem
...
| keytool -keystore ca.jks -storepass password -gencert -validity 10000 -alias ca -ext ku:c=dig,keyEnc -ext "san=dns:localhost,ip:192.1.1.18" -ext eku=sa,ca -rfc > client.pem
